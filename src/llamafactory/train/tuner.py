...
from .muti_scoring.workflow import run_ms
...
def _training_function(config: dict[str, Any]) -> None:
    ...
    elif finetuning_args.stage == "ms":
        run_ms(model_args,data_args,training_args,finetuning_args,generating_args,callbacks)
